...
Indice* Archivo::leeIndice(DIR_t direccion){
    Indice *ind=NULL;
    ...
    if(this->abreArchivo())
    {
        ...
        fread(ind,sizeof(Indice),1,_arch);
...
DIR_t Archivo::escribeIndice(Indice* indice,DIR_t direccion){
    ...
    if(this->abreArchivo())
    {
        ...
        fwrite(indice,sizeof(Indice),1,_arch);
