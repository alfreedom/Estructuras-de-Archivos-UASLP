...
void GenerateHelp()
{
    FILE *f=fopen("HELPINDEX","w");

    if(f)
    {
        fprintf(f,"**************** AYUDA DE LA ORGANIZACIÖN SECUENCIAL INDEXADA *****************\n\n");
        fprintf(f,"NOMBRE:\n");
        fprintf(f,"    indexada (linux)   Organización Secuencial Indexada\n\n");
        fprintf(f,"SINTAXYS:\n");
        fprintf(f,"    indexada <opncion1> parametro <opcion2> parametro ...\n\n");
        fprintf(f,"DESCRIPCION:\n");
        fprintf(f,"    Crea y  manipula  registros de un diccionario de manera secuencial con indices\n");
        ...
        fprintf(f,"    MODIFICA: -d dic.sec -m TABLA CLAVE\n\n");
